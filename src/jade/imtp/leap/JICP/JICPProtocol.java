...
public class JICPProtocol extends TransportProtocol {
	...
	public static final long DEFAULT_RETRY_TIME = 100000;              // 10 sec
	public static final long DEFAULT_KEEP_ALIVE_TIME = 600000;         // 1 min
	public static final long DEFAULT_RESPONSE_TIMEOUT_OFFSET = 300000;  // 30 sec
	public static final double DEFAULT_RESPONSE_TIMEOUT_MULTIPLICATIVE_FACTOR = ((double)10000) / (5 * 1024);  // 5Kb/1sec
